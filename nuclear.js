...
var content2= '<h1>旦尼丁</h1>'+'<p>但尼丁市區觀光，古老的奧塔哥大學的鐘塔和歌德式建築的修道院，文藝復興式的但尼丁火車站，加上維多利'+
...
var content3= '<h1>第阿納螢火蟲洞</h1>'+'<p>別具魅力的渡假城鎮第阿納，是探訪螢火蟲洞的最佳基地。與北島鐘乳石洞不同之處，是因地下水源充沛且不斷'+
...
var content4= '<h1>峽灣國家公園</h1>'+'<p>佔地面積達 25萬公頃於1986年已被授予世界遺產區。此外，前往密佛頌峽灣的道路被人稱為全世界風景最好的高地公'+
'路之一。早上在峽灣巡弋航程中您有機會觀賞到紐西蘭特有的寒帶動物：如紐西蘭軟毛海豹、凸吻海豚等或峽灣雞冠企鵝或藍企鵝等野生動物。</p>'+
'<img style="width:250px; float:right" src="images/6.jpg"></img>';
var content5= '<h1>皇后鎮</h1>'+'<p>皇后鎮從過去三十年間從一個寧靜的湖濱農業小鎮發展成一座全年無休的觀光都市。乾燥的大陸氣候，加上純淨的空氣，使'+
'得陽光得以在此千變萬化，創造出別無法擁有的獨特景觀。</p>'+'<img style="width:250px; float:right" src="images/7.jpg"></img>';
var content6= '<h1>費力小鎮-基督城</h1>'+'</p>早餐後與親切的農場主人道別，返回坎特伯里平原的路上，一望無際綠草與點點的白羊最讓人忘懷。午餐安排台籍廚師烹調的高級料'+
  ...
  map = new google.maps.Map(document.getElementById("map_canvas"),mapOptions);
   $(document).ready(function(){
    $('#all').click(function(){
      ...
      setViews(2,2,-45.875682, 170.502400,"ddd",content2);
      setViews(2,3,-45.415641, 167.713320,"ddd",content3);
      setViews(3,4,-45.25, 167.43,"ddd",content4);
      setViews(3,5,-45.029641, 168.662501,"ddd",content5);
      setViews(4,6,-43.530812, 172.640276,"ddd",content6);
      setline();
    });
    ...
    $('#second').click(function(){
      ...
      setViews(2,1,-45.875682, 170.502400,"ddd",content2);
      setViews(2,2,-45.415641, 167.713320,"ddd",content3);
      setline();
      
    });
    $('#thrid').click(function(){
      checkMarkers();
            setViews(3,1,-45.25, 167.43,"ddd",content4);
      setViews(3,2,-45.029641, 168.662501,"ddd",content5);
      setline();
    });
     $('#forth').click(function(){
      checkMarkers();
            setViews(4,1,-43.530812, 172.640276,"ddd",content6);
      setline();
    });
...
function setline(){
  ...
  if(markerLength>1){
    for(var i=0; i<markerLength; i++){
      flightPoint.push(markers[i].position);
